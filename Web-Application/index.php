        ...
        <div class="nano">
            <div class="nano-content">
                <ul>
                    ...
                    <li><a href="pages/company.php"><i class="ti-rss"></i> Company </a></li>
                    <li><a href="pages/projects.php"><i class="ti-layout-grid2"></i> Projects </a></li>
                    <li><a href="pages/items.php"><i class="ti-layout-grid4-alt"></i> Items </a></li>
                    <li><a href="pages/category.php"><i class="ti-layout-column3"></i> Category </a></li>
                    <li><a href="pages/products.php"><i class="ti-view-list-alt"></i> Products </a></li>
                    <li><a href="pages/quotation.php"><i class="ti-layout-width-default"></i> Quotation </a></li>
                    <li><a href="pages/invoice.php"><i class="ti-menu"></i> Invoice </a></li>
